...
const TokenBalance = ({ name, walletAddress }) => {
  ...
  const notifySuccess = () => toast.success('Transaction Complete')
  ...
  return (
    <div className='flex mx-2'>
      <div className='flex items-center bg-[#121A2B] text-zinc-300 w-fit p-2 px-3 rounded-l-lg'>
      ...
      <div className='flex items-center p-2 px-2 bg-[#1D315B] rounded-r-lg'>
        <copyIcon.icon
